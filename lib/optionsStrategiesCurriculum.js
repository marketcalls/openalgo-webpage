...
// LIVE NIFTY option-chain data, so the charts and the nine numbers match the builder exactly.
...
export const PARTS = [
  {
    ...
    chapters: [
      { slug: "the-strategy-builder", title: "The Strategy Builder and the Payoff Diagram",
        summary: "Before any strategy, you need to read a payoff diagram. Learn what the curve shows, the orange at-expiry line versus the blue T+0 line, the sigma bands, and how OpenAlgo's strategy builder draws it from your legs on live NIFTY data.",
        learn: ["What a payoff diagram shows", "The at-expiry vs the T+0 curve", "Profit and loss zones", "Legs: the pieces of a strategy", "The sigma bands and spot line", "Reading a live example"], tags: ["Foundations"] },
  ...
  },
  {
    ...
    chapters: [
      { slug: "long-call-short-put", title: "Long Call and Short Put",
        summary: "The two single-leg bullish trades. Learn the long call (limited risk, unlimited upside) and the short put (collect premium, large downside), the two ends of the bullish spectrum, on live NIFTY payoffs.",
        learn: ["The long call", "Limited risk, unlimited upside", "The short put", "Collecting premium, large risk", "Buyer vs seller bullishly", "Reading the live payoffs"], tags: ["Bullish"] },
      { slug: "bull-call-spread", title: "The Bull Call Spread",
        summary: "A mildly bullish trade with capped cost and capped profit. Learn how buying one call and selling a higher one builds a cheaper, defined-risk way to be bullish, with the live NIFTY metrics.",
        learn: ["A mildly bullish view", "Buy one call, sell a higher call", "Capped cost and capped profit", "The breakeven", "When to prefer it over a long call", "Reading the live payoff"], tags: ["Bullish"] },
      { slug: "bull-put-spread", title: "The Bull Put Spread",
        ...
        learn: ["A bullish, premium-collecting view", "Sell a put, buy a lower put", "The net credit", "Defined maximum loss", "Probability of profit", "Reading the live payoff"], tags: ["Bullish"] },
      { slug: "bull-ratio-synthetic", title: "Ratio Back Spread, Synthetic and Range Forward",
        summary: "Three more bullish shapes. Learn the call ratio back spread (cheap, explosive upside), the long synthetic future (calls and puts that mimic a future) and the range forward, with their live payoffs and the risks to watch.",
        learn: ["The call ratio back spread", "Why it can be a credit trade", "The long synthetic future", "Why it equals a future", "The range forward collar", "Reading the live payoffs"], tags: ["Bullish"] },
      { slug: "bullish-butterfly-condor", title: "Bullish Butterfly and Bullish Condor",
        summary: "Defined-risk ways to target a specific upside zone. Learn the bullish butterfly and bullish condor, all-call structures that pay the most if NIFTY drifts up to a chosen level, with live metrics.",
        learn: ["A targeted bullish view", "The bullish butterfly", "The bullish condor", "Cheap, high reward to risk", "Why the POP is low", "Reading the live payoffs"], tags: ["Bullish"] },
    ],
  },
  {
    id: "C",
    ...
    chapters: [
      { slug: "long-put-short-call", title: "Long Put and Short Call",
        summary: "The two single-leg bearish trades. Learn the long put (limited risk, large downside profit) and the short call (collect premium, unlimited risk), the two ends of the bearish spectrum, on live NIFTY payoffs.",
        learn: ["The long put", "Limited risk, large profit on a fall", "The short call", "Collecting premium, unlimited risk", "Buyer vs seller bearishly", "Reading the live payoffs"], tags: ["Bearish"] },
      { slug: "bear-call-spread", title: "The Bear Call Spread",
        summary: "A bearish credit trade. Learn how selling a call and buying a higher one collects premium with defined risk, profiting if NIFTY stays below the short strike, with live metrics.",
        learn: ["A bearish, premium-collecting view", "Sell a call, buy a higher call", "The net credit", "Defined maximum loss", "Profit if price stays down", "Reading the live payoff"], tags: ["Bearish"] },
      { slug: "bear-put-spread", title: "The Bear Put Spread",
        summary: "A defined-risk bearish trade. Learn how buying a put and selling a lower one builds a cheaper way to profit from a fall, with both profit and loss capped, on live NIFTY data.",
        learn: ["A bearish view", "Buy a put, sell a lower put", "Capped cost and capped profit", "The breakeven", "When to prefer it over a long put", "Reading the live payoff"], tags: ["Bearish"] },
      { slug: "bear-ratio-synthetic", title: "Put Ratio Back Spread, Synthetic and Risk Reversal",
        summary: "Three more bearish shapes. Learn the put ratio back spread (cheap, explosive downside), the short synthetic future and the risk reversal, with their live payoffs and the risks to respect.",
        learn: ["The put ratio back spread", "The short synthetic future", "Why it equals a short future", "The risk reversal", "Where the unlimited risk hides", "Reading the live payoffs"], tags: ["Bearish"] },
      { slug: "bearish-butterfly-condor", title: "Bearish Butterfly and Bearish Condor",
        ...
        learn: ["A targeted bearish view", "The bearish butterfly", "The bearish condor", "Cheap, high reward to risk", "Why the POP is low", "Reading the live payoffs"], tags: ["Bearish"] },
    ],
  },
  {
    id: "D",
    ...
    chapters: [
      { slug: "long-straddle-strangle", title: "Long Straddle and Strangle: Betting on a Big Move",
        summary: "Sometimes you expect a large move but not which way. Learn the long straddle and strangle, buying both a call and a put, the two breakevens, and the time decay that fights you, with live NIFTY metrics.",
        learn: ["A non-directional, big-move view", "The long straddle", "The cheaper long strangle", "Two breakevens", "Time decay as the enemy", "Reading the live payoffs"], tags: ["Volatility"] },
      { slug: "short-straddle-strangle", title: "Short Straddle and Strangle: Betting on Calm",
        ...
        learn: ["A range-bound view", "The short straddle", "The wider short strangle", "Collecting premium", "Unlimited risk and large margin", "Reading the live payoffs"], tags: ["Volatility"] },
    ],
  },
  {
    id: "E",
    ...
    chapters: [
      { slug: "iron-condor", title: "The Iron Condor",
        summary: "The most popular income strategy. Learn how four legs build a wide profit zone that pays you if NIFTY stays in a range, the long and short versions, defined risk on both ends, with live metrics.",
        learn: ["A defined-risk range play", "Four legs explained simply", "The wide profit plateau", "Long vs short iron condor", "Two breakevens and the POP", "Reading the live payoff"], tags: ["Range"] },
      { slug: "iron-fly-butterfly", title: "The Iron Fly and the Butterfly",
        summary: "Tighter, higher-reward cousins of the condor. Learn the iron fly (long and short) and the call and put butterfly, which pay the most if NIFTY pins one strike, with live payoff shapes.",
        learn: ["The iron fly", "Long vs short iron fly", "The call and put butterfly", "A pin-the-strike bet", "Higher reward, narrower zone", "Reading the live payoffs"], tags: ["Range"] },
      { slug: "ratio-and-backspreads", title: "Call and Put Ratio Spreads",
        summary: "Strategies with an unequal number of legs. Learn the call ratio spread and the put ratio spread, where selling extra options funds the trade but opens unlimited risk on one side, with live metrics.",
        learn: ["Unequal legs explained", "The call ratio spread", "The put ratio spread", "Where the naked risk hides", "Credit vs debit versions", "Reading the live payoffs"], tags: ["Range"] },
      { slug: "jade-lizard", title: "The Jade Lizard and Reverse Jade Lizard",
        summary: "Neat credit structures that remove the risk on one side. Learn the jade lizard (no upside risk) and the reverse jade lizard (no downside risk), and how the credit erases one tail, with live payoffs.",
        learn: ["The jade lizard structure", "No risk on the upside", "The reverse jade lizard", "No risk on the downside", "Why the credit matters", "Reading the live payoffs"], tags: ["Range"] },
    ],
  },
  {
    id: "F",
    ...
    chapters: [
      { slug: "advanced-multileg", title: "Batman, Double Fly and Double Condor",
        summary: "The big multi-leg structures. Learn the batman (two ratio wings), the double fly and the double condor, which place two range structures side by side for a wider or twin-peaked profit zone, with live metrics.",
        learn: ["Stacking structures", "The batman", "The double fly", "The double condor", "Twin profit peaks", "Reading the live payoffs"], tags: ["Advanced"] },
      { slug: "calendars", title: "Calendar and Diagonal Spreads: Trading Time",
        ...
        learn: ["Selling near, buying far", "The call and put calendar", "The diagonal spread", "The calendar tent shape", "Profiting from time decay", "Reading the live payoffs"], tags: ["Advanced"] },
