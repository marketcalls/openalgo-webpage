...
export const PARTS = [
  ...
  },
  {
    ...
    chapters: [
      ...
      { slug: "portfolio-heat", title: "Portfolio Heat: Your Total Open Risk",
        summary: "One percent per trade still adds up. With several positions open at once - especially correlated ones - your total risk can quietly reach eight percent or more. How to measure portfolio heat, why correlation and sector overlap hide it, and how to cap it.",
        learn: ["What portfolio heat is", "Per-trade risk vs total risk", "Correlation and hidden concentration", "Sector overlap", "Gross vs net exposure", "Setting a total-heat limit"], tags: ["Trader"] },
    ],
  },
  {
    id: "E",
    ...
    chapters: [
      ...
      { slug: "broker-rms-reality", title: "The Broker's Risk System",
        summary: "Your broker's risk system (RMS) can close your positions before you expect. Cash vs pledged collateral, the pledge haircut, margin shortfall, auto square-off timing, the cash-component rule and peak-margin penalties - the broker-side realities that catch beginners.",
        learn: ["What an RMS does", "Cash vs pledged collateral", "The pledge haircut", "Margin shortfall and square-off", "Auto square-off timing", "Peak-margin penalties"], tags: ["Leverage"] },
  ...
  },
  {
    ...
    desc: "Every live number in this course - lot sizes, margins, charges, SEBI figures - changes over time. Here is where to verify them.",
    chapters: [
      { slug: "sources-and-staying-current", title: "Sources and Staying Current",
        summary: "Lot sizes, expiry dates, margins, charges and SEBI figures all change. This reference shows exactly where to verify every live fact this course uses, and the simple 'as of date' habit that stops your own numbers from going stale.",
        learn: ["Where to check NSE lot sizes and specs", "Expiry calendar sources", "The SEBI F&O studies", "Margin and settlement rules", "The 'as of date' habit", "A fact-to-source table"], tags: ["Money"] },
    ],
  },
];
