...
export const PARTS = [
  ...
  {
    id: "F",
    name: "Market Controls and Adjustments",
    desc: "The exchange rules that shape what you can trade: position limits and the ban, corporate-action adjustments, and the price bands and halts that bound every session.",
    chapters: [
      { slug: "position-limits-and-ban", title: "Position Limits, the F&O Ban and Quantity Freeze",
        summary: "The exchange caps how much of a contract anyone can hold. Learn the market-wide position limit, the client and member limits, what tips a stock into the F&O ban period and the rule that you can take no fresh positions while it lasts, and the quantity freeze that forces a large order to be sliced.",
        learn: ["Market-wide position limit (MWPL)", "Client and member limits", "What triggers the F&O ban", "No fresh positions in a ban", "Quantity freeze and order slicing", "Reading the ban list"], tags: ["Risk"] },
      { slug: "corporate-actions", title: "Corporate Actions and F&O Adjustments",
        summary: "When a company splits its stock, issues a bonus or pays a special dividend, its futures and options are adjusted so open positions keep their value. Learn how a split or bonus changes the lot size and strike, how the adjustment factor works, the special-dividend threshold that triggers a change, and how rights and mergers are handled.",
        learn: ["Why F&O must be adjusted", "Splits and bonus issues", "The adjustment factor", "Lot size and strike changes", "Special dividends and the threshold", "Mergers and rights"], tags: ["Settlement"] },
      { slug: "price-bands-and-halts", title: "Price Bands, Circuits and Trading Halts",
        summary: "A contract is not free to move any distance in a day. Learn the operating ranges and price bands that bound a future, why an order can be rejected for breaching them, how index circuit breakers halt the whole market, and how these controls change your risk and your ability to get out.",
        learn: ["Operating ranges and price bands", "Why an order gets rejected", "Dynamic price bands in F&O", "Index circuit breakers", "Halts and how they lift", "Trading near the limits"], tags: ["Execution"] },
    ],
  },
  {
    id: "G",
