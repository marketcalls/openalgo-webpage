          ...
          <div className="obsidian-card rounded-xl sm:rounded-2xl p-5 sm:p-8 ghost-border">
            ...
            <div className="space-y-4">
              {[
                ...
                { time: "8:00–9:00 AM", event: "Log in to OpenAlgo → authenticates with broker", icon: Key },
                { time: "Auto", event: "Master contract downloads (~1 lakh symbols, takes 10–20 sec)", icon: Database },
        ...
        <div className="container max-w-4xl px-4 sm:px-6">
          ...
          <div>
            ...
            <p className="text-on-surface-variant mb-5">
              Most brokers offer SDKs in 1–2 languages. OpenAlgo gives you SDKs in 6 — use whichever language
      ...
      <div className="py-12 sm:py-16 md:py-20">
        <div className="container max-w-4xl px-4 sm:px-6">
          ...
          <div className="space-y-4">
            ...
            <ExpandableCard title="Step 2: Install Python (3.12–3.14)" icon={Terminal}>
              <p className="text-on-surface-variant mb-4">
            ...
            <ExpandableCard title="Step 6: Run OpenAlgo!" icon={Play}>
              <div className="space-y-4 text-on-surface-variant">
                ...
                <p>
                  First run installs ~177 libraries (takes 2–3 minutes). After that, OpenAlgo starts on <code className="px-1.5 py-0.5 rounded surface-high text-xs text-on-surface">localhost:5000</code>.
            ...
            {[
              {
                ...
                desc: "Broker tokens expire every night. Log in daily between 8–9 AM IST. There's no way around this — it's a SEBI regulation.",
                icon: Clock,
              },
              {
              ...
              },
              {
                ...
                desc: "SEBI allows 10 orders/second. Fetching historical data frequently also counts against limits. 5–10 strategies is a practical maximum.",
                icon: AlertTriangle,
              },
              {
