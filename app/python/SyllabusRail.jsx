...
export default function SyllabusRail() {
  ...
  const activeSlug = pathname.startsWith("/python/") ? pathname.slice("/python/".length) : "";
    ...
    <>
      ...
      >
        ...
        <div className="mt-5">
          ...
          <Link
            href="/python/whats-next"
            onClick={() => setOpen(false)}
            className={`syllabus-link ${activeSlug === "whats-next" ? "active" : ""}`}
          >
            <span className="num"><Check className="h-3 w-3" /></span>
