...
// content JSON from content/amibroker/md-<locale>/ instead of the English
// content/amibroker/md/, writing to lib/content-i18n/amibroker/<locale>.js
// instead of lib/amibrokerContentData.json. English output/behavior is
...
const MD_DIR = LOCALE === "en"
  ? path.join(ROOT, "content", "amibroker", "md")
  : path.join(ROOT, "content", "amibroker", `md-${LOCALE}`);
const IMG_DIR = path.join(ROOT, "public", "amibroker", "images");
const DATA_OUT = LOCALE === "en"
  ? path.join(ROOT, "lib", "amibrokerContentData.json")
  : path.join(ROOT, "lib", "content-i18n", "amibroker", `${LOCALE}.js`);
