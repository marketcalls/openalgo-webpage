...
const MD_DIR = path.join(ROOT, "content", "options-basics", "md");
const IMG_DIR = path.join(ROOT, "public", "options-basics", "images");
const DATA_OUT = path.join(ROOT, "lib", "optionsBasicsContentData.json");
...
console.log(`Generated lib/optionsBasicsContentData.json (${kb} KB, ${built}/${MAX} chapters with content)`);
