...
// content JSON from content/futures/md-<locale>/ instead of the English
// content/futures/md/, writing to lib/content-i18n/futures/<locale>.js
// instead of lib/futuresContentData.json. English output/behavior is
...
const MD_DIR = LOCALE === "en"
  ? path.join(ROOT, "content", "futures", "md")
  : path.join(ROOT, "content", "futures", `md-${LOCALE}`);
const IMG_DIR = path.join(ROOT, "public", "futures", "images");
const DATA_OUT = LOCALE === "en"
  ? path.join(ROOT, "lib", "futuresContentData.json")
  : path.join(ROOT, "lib", "content-i18n", "futures", `${LOCALE}.js`);
