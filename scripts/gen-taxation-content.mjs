...
const MD_DIR = path.join(ROOT, "content", "taxation", "md");
const IMG_DIR = path.join(ROOT, "public", "taxation", "images");
const DATA_OUT = path.join(ROOT, "lib", "taxationContentData.json");
...
console.log(`Generated lib/taxationContentData.json (${kb} KB, ${built}/${MAX} chapters with content)`);
