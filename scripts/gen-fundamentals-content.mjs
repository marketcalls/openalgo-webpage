...
// content JSON from content/fundamentals/md-<locale>/ instead of the English
// content/fundamentals/md/, writing to lib/content-i18n/fundamentals/<locale>.js
// instead of lib/fundamentalsContentData.json. English output/behavior is
...
const MD_DIR = LOCALE === "en"
  ? path.join(ROOT, "content", "fundamentals", "md")
  : path.join(ROOT, "content", "fundamentals", `md-${LOCALE}`);
...
const DATA_OUT = LOCALE === "en"
  ? path.join(ROOT, "lib", "fundamentalsContentData.json")
  : path.join(ROOT, "lib", "content-i18n", "fundamentals", `${LOCALE}.js`);
const CHAPTERS = 40;
