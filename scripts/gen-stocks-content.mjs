...
const MD_DIR = path.join(ROOT, "content", "stocks", "md");
const IMG_DIR = path.join(ROOT, "public", "stocks", "images");
const DATA_OUT = path.join(ROOT, "lib", "stocksContentData.json");
...
console.log(`Generated lib/stocksContentData.json (${kb} KB, ${built}/${MAX} chapters with content)`);
