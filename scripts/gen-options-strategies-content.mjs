// Build-time generator for the "Options Strategies" course content.
// Renders every chapter's markdown into a single JSON module
// (lib/optionsStrategiesContentData.json) so the Next pages need NO filesystem access at
...
// public/options-strategies/images/, a labelled placeholder is rendered that tells the author
...
function renderImage(spec) {
  ...
  const src = `/options-strategies/images/${file}`;
...
<code class="shot-ph-path">public/options-strategies/images/${esc(file)}</code>
</div>
${cap}</figure>`;
}
