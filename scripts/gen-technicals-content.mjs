...
const MD_DIR = path.join(ROOT, "content", "technicals", "md");
const IMG_DIR = path.join(ROOT, "public", "technicals", "images");
const DATA_OUT = path.join(ROOT, "lib", "technicalsContentData.json");
...
console.log(`Generated lib/technicalsContentData.json (${kb} KB, ${built}/${MAX} chapters with content)`);
