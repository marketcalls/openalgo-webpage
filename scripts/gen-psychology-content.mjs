...
const MD_DIR = path.join(ROOT, "content", "trading-psychology", "md");
const IMG_DIR = path.join(ROOT, "public", "trading-psychology", "images");
const DATA_OUT = path.join(ROOT, "lib", "psychologyContentData.json");
...
console.log(`Generated lib/psychologyContentData.json (${kb} KB, ${built}/${MAX} chapters with content)`);
