...
{{image: ch11-weighted-basket.png | The Nifty 50 drawn as a weighted basket - heavyweights like Reliance and the big banks fill most of the space, while the smallest members are slivers | infographic}}

Here is roughly what sits at the top of the Nifty 50 today. Treat every figure as **approximate** - weights drift daily as prices move and are reshuffled twice a year.

| Rank | Company | Sector | Approx. weight |
|---|---|---|---:|
| 1 | Reliance Industries | Energy / Retail / Telecom | ~9.3% |
| 2 | HDFC Bank | Banking | ~6.4% |
| 3 | Bharti Airtel | Telecom | ~5.9% |
| 4 | ICICI Bank | Banking | ~5.2% |
| 5 | State Bank of India | Banking | ~5.0% |
| 6 | Tata Consultancy Services | IT | ~4.0% |
| 7 | Bajaj Finance | Financials | ~3.2% |
| 8 | Larsen & Toubro | Infrastructure | ~3.0% |
| 9 | Hindustan Unilever | FMCG | ~2.7% |
| 10 | Sun Pharma | Pharma | ~2.3% |

{{image: ch11-top-weights-bar.png | The top ten Nifty 50 constituents by approximate weight - a steep staircase from Reliance down, showing how lopsided the index really is | chart}}

Look at the concentration. The **top 10 names alone make up nearly half** the entire 50-stock index. The remaining 40 companies share the other half. And notice how **financials dominate** - lump the banks, Bajaj Finance and other lenders together and roughly a third of the Nifty is one sector. That is why a bad day for banks is so often a bad day for the whole index.

:::fact
A single company can swing the entire Indian market. When Reliance Industries reports strong results and its stock jumps a few percent, that one move alone can nudge the Nifty up noticeably - before HDFC Bank, Airtel or any of the other 47 members have done a thing. One stock, roughly a tenth of the basket.
:::
...
Suppose **Reliance has a ~9.3% weight and rises 2%** on a good day. Its push on the index is:

0.093 x 2% = **0.186%** - call it about **+0.19%**.

That single stock, moving a modest 2%, lifts the whole Nifty by nearly a fifth of a percent.
...
Same 2% move in both stocks - but Reliance pushed the index roughly **30 times harder**, purely because its weight is 30 times bigger. The little stock can have a fantastic day and the index will barely register it.
