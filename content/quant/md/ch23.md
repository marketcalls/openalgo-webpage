...
{{example: ch23/01_biggest_moves.py | The market's worst days vs the circuits | INDEX}}
...
{{example: ch23/02_circuit_distribution.py | Where the circuit sits in the tail | INDEX}}
