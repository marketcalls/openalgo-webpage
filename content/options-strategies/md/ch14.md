...
:::warn
A short straddle has a maximum profit of Rs 46,858 and a maximum loss that is UNLIMITED on both sides. You have sold a naked call, so a strong rally costs you without limit above 24,771, and a naked put, so a crash costs you all the way down through 23,329 and far below. This is two uncovered short legs stacked on the same strike. A single gap, up or down, can erase many months of quiet credits in one morning.
:::
...
- The **maximum loss is unlimited on both sides** of each trade, because every sold leg is naked, and that is the fact that governs everything.
